...
\begin{itemize}
	...
	\begin{itemize*}
		...
		\item Designed an automated testing framework significantly increase client-side code coverage
		\item Developed highly flexible and dynamic user interfaces for use within TextNow
		\item Created a TextNow Chrome Extension for a company wide hackathon in Javascript
	\end{itemize*}
