...
\begin{itemize}
	...
	\begin{itemize*}
		...
		\item Developed highly flexible and dynamic user interfaces for use within TextNow		
		\item Designed an automated testing framework to significantly increase iOS test coverage
		\item Created a TextNow Chrome Extension during a company wide hackathon in Javascript
	\end{itemize*}
	...
	\begin{itemize*}
		...
		\item Wrote detailed supporting documents inserted alongside each map
	\end{itemize*}
...
\begin{description*}
	...
	C, \CPP, Objective-C, Java, SQL, HTML, CSS, XML
	\item[Familiar Languages:]
	C\#, Bash, Python, JavaScript, \LaTeX
	\item[Frameworks and APIs:]
	iOS, Android, Swing, GWT, JUnit, Mockito, Hibernate, Spring, Ant, PostgreSQL
	\item[Tools:]
	Windows, OSX, Ubuntu, Eclipse, IntelliJ, Visual Studio, XCode, Vim, Git
\end{description*}
\end{indentsection}
