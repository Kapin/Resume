...
\begin{itemize}[leftmargin=*]
	...
	\begin{itemize*}
		\item Designed a method of provisioning devices for premium features on partner networks
		\item Hacked the Android emulator in C to allow for the configuration of previously hard-coded properties
		\item Developed the client-side implementation of RESTful Contact Backup in a company-wide hackathon
